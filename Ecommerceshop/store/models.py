...
class Product(models.Model):
    ...
    slug = models.SlugField(max_length=100, unique=True,
                            allow_unicode=True)  # ผูกข้อมูลไปกับ path
...
class PaymentType(models.Model):
    ...
    payment_image = models.ImageField(
        upload_to="payment", null=True, blank=True)
    active = models.BooleanField(default=False)
...
class Order(models.Model):
    ...
    customer_contract = models.ForeignKey(
        Customer_contract, on_delete=models.CASCADE)
    ...
    order_id = models.CharField(
        default=random_number, max_length=255, null=False, unique=True, blank=False)
    ...
    transfer_image = models.ImageField(
        upload_to="slip", null=True, default=None, blank=True)
